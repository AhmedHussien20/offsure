...
export class AdminResourceManagerPanelComponent implements OnChanges, OnDestroy {
  ...
  openResetPasswordModal(): void {
    ...
    modalRef.componentInstance.memberId = this.manager.id;
    modalRef.componentInstance.memberName =
      this.manager.fullName?.trim() ||
      `${this.manager.firstName} ${this.manager.lastName}`.trim();
    modalRef.componentInstance.accountType = 'resourceManager';
  }
