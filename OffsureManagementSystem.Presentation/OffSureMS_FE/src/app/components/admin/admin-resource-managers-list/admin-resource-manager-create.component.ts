...
@Component({
  selector: 'app-admin-resource-manager-create',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, GenericFormComponent],
  template: `
    <div class="modal-header">
      <h5 class="modal-title">Add Resource Manager</h5>
...
export class AdminResourceManagerCreateComponent {
  saving = false;
  form!: FormGroup;
  ...
  submit(): void {
    ...
    this.teamMembersService
      ...
      .subscribe({
        next: () => {
          this.toastr.success('Resource manager created.');
          this.saving = false;
