...
namespace OffsureManagementSystem.Infrastructure.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<RegisterResponseDto> RegisterAsync(RegisterDto dto)
        {
            ...
            // TODO: await _emailService.SendVerificationEmailAsync(user.Email, user.EmailVerificationToken);
        ...
        public async Task ForgotPasswordAsync(ForgotPasswordDto dto)
        {
            ...
            // TODO: await _emailService.SendPasswordResetEmailAsync(user.Email, user.PasswordResetToken);
        }
